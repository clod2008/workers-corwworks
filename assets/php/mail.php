...
header('AMP-Access-Control-Allow-Source-Origin: https://coreworks.com.ar/assets/php/');
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $ticket = trim($_POST["choose_ticket"]);        
        ...
        // Set the recipient email address. guidotasselli@coreworks.com.ar   info@coreworks.com.ar     
        $recipient = "info@coreworks.com.ar"; 

        // Set the email subject.
        $subject = "Coreworks - $name";
            ...
            <body style="margin:0; padding:0; background-color:#F3F3F3;">
                <center>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F2F2F2">
						...
						<tr>
							<td align="center" valign="top">
                                <a href="http://coreworks.com.ar/" target="_blank"><img width="120" src="http://coreworks.com.ar/assets/img/logo-black.png" alt="HasThemes"></a>
                            </td>
						</tr>
        ...
        $email_headers .= 'From:' . $name . ' ' . 'info@coreworks.com.ar' . "\r\n";
        $email_headers .= 'Reply-To:' . $email . "\r\n";
       /*
        $domain_url = (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]";
        header("Content-type: application/json");
        header("Access-Control-Allow-Credentials: true");
        header("Access-Control-Allow-Origin: ". str_replace('.', '-','https://coreworks.com.ar') .".cdn.ampproject.org");
        header("AMP-Access-Control-Allow-Source-Origin: " . $domain_url);
        header("Access-Control-Expose-Headers: AMP-Access-Control-Allow-Source-Origin");
        header("AMP-Redirect-To: https://co.com/index.html");
        ...
        */
        ...
        if (mail($recipient, $subject, $email_content, $email_headers)) {
            ...
            echo "Oops! Algo salio mal, podrás reenviarnos tu mensaje, gracias.";
        }

    } else {
        // Not a POST request, set a 403 (forbidden) response code.
        http_response_code(403);
        echo "Estamos teniendo un problema, podrás intentarlo nuevamente más tarde.";
    }
