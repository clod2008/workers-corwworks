...
header("Access-Control-Allow-Origin: *");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Set the recipient email address estilodevidaespectacular@gmail.com, cesarfit73@hotmail.com        
        $recipient = array("sebastian@skydev.com.ar", "estilodevidaespectacular@gmail.com");

        // Set the email subject.
        $subject = "Salud es Riqueza - $name";
        ...
        $email_headers .= 'From:' . $name . ' ' . 'sebastian@skydev.com.ar, estilodevidaespectacular@gmail.com' . "\r\n";
